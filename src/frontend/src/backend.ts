...
import type { ExternalBlob as _ExternalBlob, PositiveFloat as _PositiveFloat, Project as _Project, ProjectStatus as _ProjectStatus, RestorationSubmission as _RestorationSubmission, SubmissionStatus as _SubmissionStatus, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async approveRestoration(arg0: SubmissionId): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.approveRestoration(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAdminSubmissions(): Promise<Array<RestorationSubmission>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAdminSubmissions();
    ...
    async getGreenMap(): Promise<Array<Project>> {
        if (this.processError) {
            try {
                const result = await this.actor.getGreenMap();
    ...
    async getRestorationSubmissions(): Promise<Array<RestorationSubmission>> {
        if (this.processError) {
            try {
                const result = await this.actor.getRestorationSubmissions();
                return from_candid_vec_n10(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async purchaseCredits(arg0: ProjectId, arg1: bigint): Promise<boolean> {
        if (this.processError) {
            try {
    ...
    async rejectRestoration(arg0: SubmissionId, arg1: string): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.rejectRestoration(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitProject(arg0: string, arg1: string, arg2: string, arg3: PositiveFloat, arg4: string, arg5: string, arg6: string): Promise<ProjectId> {
        if (this.processError) {
            try {
                const result = await this.actor.submitProject(arg0, arg1, arg2, arg3, arg4, arg5, arg6);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitRestoration(arg0: ProjectId, arg1: string, arg2: string, arg3: Array<ExternalBlob>): Promise<SubmissionId> {
        if (this.processError) {
            try {
                const result = await this.actor.submitRestoration(arg0, arg1, arg2, await to_candid_vec_n26(this._uploadFile, this._downloadFile, arg3));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateProjectStatus(arg0: ProjectId, arg1: ProjectStatus): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.updateProjectStatus(arg0, to_candid_ProjectStatus_n28(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_Project_n21(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Project): Project {
    return from_candid_record_n22(_uploadFile, _downloadFile, value);
}
async function from_candid_RestorationSubmission_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _RestorationSubmission): Promise<RestorationSubmission> {
    return await from_candid_record_n12(_uploadFile, _downloadFile, value);
}
function from_candid_SubmissionStatus_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _SubmissionStatus): SubmissionStatus {
...
function from_candid_opt_n25(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Project]): Project | null {
    return value.length === 0 ? null : from_candid_Project_n21(_uploadFile, _downloadFile, value[0]);
}
...
async function from_candid_record_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        status: from_candid_SubmissionStatus_n15(_uploadFile, _downloadFile, value.status),
...
function from_candid_record_n22(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    gpsCoordinates: string;
    createdAt: bigint;
    landAreaHectares: _PositiveFloat;
    creditsPurchased: bigint;
    creditsRequired: bigint;
    startDate: string;
}): {
    ...
    return {
        ...
        creditsPurchased: value.creditsPurchased,
...
function from_candid_variant_n24(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "verified" in value ? ProjectStatus.verified : "pending" in value ? ProjectStatus.pending : "rejected" in value ? ProjectStatus.rejected : "inProgress" in value ? ProjectStatus.inProgress : value;
}
async function from_candid_vec_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_RestorationSubmission>): Promise<Array<RestorationSubmission>> {
    return await Promise.all(value.map(async (x)=>await from_candid_RestorationSubmission_n11(_uploadFile, _downloadFile, x)));
}
...
function from_candid_vec_n20(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Project>): Array<Project> {
    return value.map((x)=>from_candid_Project_n21(_uploadFile, _downloadFile, x));
}
...
function to_candid_ProjectStatus_n28(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: ProjectStatus): _ProjectStatus {
...
function to_candid_variant_n29(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: ProjectStatus): {
    verified: null;
} | {
    pending: null;
} | {
    ...
    return value == ProjectStatus.verified ? {
        verified: null
